...
require (
	...
	github.com/teaPartyovo/BilibiliDanmuRobot-Core v1.1.17  // 修改这行
...
replace github.com/xbclub/BilibiliDanmuRobot-Core => github.com/teaPartyovo/BilibiliDanmuRobot-Core latest  // 添加这行
